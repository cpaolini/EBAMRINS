...
if len(sys.argv) != 3:
    print(f'usage: poroboost.py component pklfile\n')
    exit(0)
...
#plt.savefig(dir + '/' + "poroboost_tree_0_comp_" + str(component) + '.png', bbox_inches='tight')

model.save_model(dir + '/' + "poroboost_component_" + str(component) + '_model.json')
